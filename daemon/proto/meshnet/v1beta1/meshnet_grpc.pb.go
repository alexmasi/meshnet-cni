...
type LocalClient interface {
	...
	BatchSkip(ctx context.Context, in *BatchSkipRequest, opts ...grpc.CallOption) (*BatchSkipResponse, error)
	ListSkipped(ctx context.Context, in *ListSkippedRequest, opts ...grpc.CallOption) (*ListSkippedResponse, error)
...
func (c *localClient) BatchSkip(ctx context.Context, in *BatchSkipRequest, opts ...grpc.CallOption) (*BatchSkipResponse, error) {
	out := new(BatchSkipResponse)
	err := c.cc.Invoke(ctx, "/meshnet.v1beta1.Local/BatchSkip", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) ListSkipped(ctx context.Context, in *ListSkippedRequest, opts ...grpc.CallOption) (*ListSkippedResponse, error) {
	out := new(ListSkippedResponse)
	err := c.cc.Invoke(ctx, "/meshnet.v1beta1.Local/ListSkipped", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LocalServer interface {
	...
	BatchSkip(context.Context, *BatchSkipRequest) (*BatchSkipResponse, error)
	ListSkipped(context.Context, *ListSkippedRequest) (*ListSkippedResponse, error)
...
func (UnimplementedLocalServer) BatchSkip(context.Context, *BatchSkipRequest) (*BatchSkipResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchSkip not implemented")
}
func (UnimplementedLocalServer) ListSkipped(context.Context, *ListSkippedRequest) (*ListSkippedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListSkipped not implemented")
}
...
func _Local_BatchSkip_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchSkipRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocalServer).BatchSkip(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/meshnet.v1beta1.Local/BatchSkip",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocalServer).BatchSkip(ctx, req.(*BatchSkipRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Local_ListSkipped_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListSkippedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocalServer).ListSkipped(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/meshnet.v1beta1.Local/ListSkipped",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocalServer).ListSkipped(ctx, req.(*ListSkippedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Local_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchSkip",
			Handler:    _Local_BatchSkip_Handler,
		},
		{
			MethodName: "ListSkipped",
			Handler:    _Local_ListSkipped_Handler,
		},
		{
